...
from app.routes import image_analysis, chat_ai, recommendations,chat
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://localhost:5173", "http://127.0.0.1:5173","http://localhost:8080"],
